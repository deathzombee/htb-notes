...
```shell-session
cdeez@htb[/htb]$ go install github.com/tomnomnom/waybackurls@latest
```
...
```shell-session
cdeez@htb[/htb]$ waybackurls -dates https://facebook.com > waybackurls.txt
cdeez@htb[/htb]$ cat waybackurls.txt
